from facev21.face_detection import Mediapipe, OpenCv, RetinaFace
from PIL import Image
import math
import numpy as np
from facev21.extension import distance

def build_model(detector_backend):
    global face_detector_obj #singleton design pattern

    backends = {
        'opencv': OpenCv.build_model,
        'retinaface': RetinaFace.build_model,
	    'mediapipe': Mediapipe.build_model
    }
...
def detect_faces(face_detector, detector_backend, img, align = True):
    backends = {
        'opencv': OpenCv.detect_face,
        'retinaface': RetinaFace.detect_face,
	    'mediapipe': Mediapipe.detect_face
    }
